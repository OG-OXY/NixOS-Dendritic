...
local FileManagerCD = Terminal .. " -e fish -c 'y; exec fish'"
local Menu = "pkill wofi && 2>/dev/null || wofi --show drun"
...
hl.bind(mainMod .. " + SHIFT + CTRL + M", hl.dsp.exec_cmd(hyprShutdown))
